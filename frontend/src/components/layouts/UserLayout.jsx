      ...
      <div className="header-wrapper">
        ...
        <nav className="menu">
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`} id="navLinks">
            ...
            {Object.values(uMenu).filter(item => item.class === 'links').map((menuItem) => (
              <li key={menuItem.id}>
            ...
            {Object.values(uMenu).filter(item => item.class === 'button').map((menuItem) => (
